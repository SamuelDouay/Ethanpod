...
public class DownloadDao extends BaseDao {
    ...
    public List<EpisodeItem> getTop8Download() {
        ...
        return executeQuery(query, ResultMappers.episodeListMapper(), new ArrayList<>(), "GET TOP 8 DOWNLOAD");
    }
    ...
    public List<EpisodeItem> getAllDownload(UserDataRequest userDataRequest) {
        ...
        return executeQueryWithParams(query, ResultMappers.episodeListMapper(), new ArrayList<>(), "GET ALL DOWNLOAD");
    }
}
